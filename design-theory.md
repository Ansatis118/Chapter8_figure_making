...
This document summarizes common publication-quality visualization conventions (the `figure_*` project folders). See [demos.md](demos.md) for links to those demos.

## 1) Core Matplotlib Style System

The dominant consistent publication style is minimalist, high-contrast, and publication-oriented:
