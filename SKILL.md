---
name: Chapter8_figure_making
description: Generates publication-ready scientific figures in Python/matplotlib with consistent consistent publication style (Helvetica/Arial-like fonts, high-contrast palettes, minimal spines, frameless legends). Use when creating bar, trend, scatter, heatmap, or multi-panel figures for papers, slides, or reports that must match repository aesthetics and print/vector export.
version: 1.0.0
license: MIT
...
Expert guidance for publication-ready scientific figures in Python/matplotlib: consistent consistent publication style, high-level plot helpers, and reproducible export. Implementation details, API, and examples live in the reference docs; this file is the quick reference.

**Demos and guidance** for this skill come from real figure-making scripts in the [Chapter8_figure_making](https://github.com/yourname/Chapter8_figure_making) repository (`figure_*` folders). See [references/demos.md](references/demos.md) for links to each project; the design theory and patterns were derived from those scripts.

## When to use this skill

- Creating **publication-ready** bar charts, trend plots, heatmaps, or multi-panel figures for papers or reports.
- Enforcing a **consistent consistent publication style** (fonts, colors, spines, export) across many figures.
...
- [references/demos.md](references/demos.md) — Real-world demos: links to [Chapter8_figure_making](https://github.com/yourname/Chapter8_figure_making) `figure_*` project folders (bar charts, trends, heatmaps, multi-panel).
