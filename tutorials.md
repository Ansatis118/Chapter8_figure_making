...
Implement the API described in [api.md](api.md) in your own code (constants, style, plot helpers, finalize). For real-world scripts that follow this style, see [demos.md](demos.md) (links to the [Chapter8_figure_making](https://github.com/yourname/Chapter8_figure_making) `figure_*` folders).
